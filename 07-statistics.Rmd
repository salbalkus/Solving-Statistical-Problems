...
**Remark:** The definition says that if $T$ is complete, then only function of $T$ that can have zero expectation on $\theta$ is the zero function, i.e. there can't be any non-zero unbiased estimates of 0 based on $T$. 
