...
5. Because $E\Big(\frac{g(T)}{\tau(\theta)}\Big)$ must integrate to 1, $\frac{g(T)}{\tau(\theta)}$ must be a pdf. Therefore, you can use the [Kernel Technique](#kernel-technique) to solve for the $g(T)$ that converts the rest of the integrand into a pdf.
