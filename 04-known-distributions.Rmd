...
- The Normal is additive. If $X_1 \sim N(\mu_1, \sigma_1^2)$ and $X_2 \sim N(\mu_2, \sigma_2^2)$, then $X + Y \sim N(\mu_1 + \mu_2, \sigma_1^2 + \sigma_2^2)$.
...
### Medians, Modes, and Other Functionals of a Distribution
...
as well as any other symmetric distribution.
